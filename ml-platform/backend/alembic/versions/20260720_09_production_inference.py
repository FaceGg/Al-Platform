...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("step_schedule", sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("load_failure_count", sa.Integer(), nullable=False),
        sa.Column("batch_size_sum", sa.Integer(), nullable=False),
        sa.Column("latency_sum_ms", sa.Integer(), nullable=False),
        sa.Column("latency_max_ms", sa.Integer(), nullable=False),
        sa.Column("latency_buckets", sa.JSON(), nullable=False),
        sa.Column("traffic_weights", sa.JSON(), nullable=False),
        sa.ForeignKeyConstraint(
            ["deployment_id"], ["inference_deployments.id"], ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("operational_guidance", sa.Text(), nullable=False),
        sa.Column("guidance_revision", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.ForeignKeyConstraint(
