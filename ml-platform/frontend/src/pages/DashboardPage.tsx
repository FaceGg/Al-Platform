  ...
  return (
    <AppLayout>
      <Row gutter={16} style={{ marginBottom: 24 }}>
        <Col span={6}>
          <Card><Statistic title={t.nav.projects} value={stats.total} prefix={<ProjectOutlined />} /></Card>
        </Col>
        <Col span={6}>
