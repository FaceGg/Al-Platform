...
const EN: Record<string, any> = {
  ...
  training: { title: "Model Training", jobs: "Training Jobs", new_job: "New Training", name: "Job Name", project: "Project", dataset_artifact: "Dataset Artifact", target_column: "Target Column", model_artifact: "Model Artifact", model_library: "Model Library Entry", feature_schema: "Feature Schema", target_schema: "Target Schema", preprocessing: "Preprocessing", logs: "Logs", error_code: "Error", details: "Details", status: "Status", start: "Start", stop: "Stop", epoch: "Epoch", metrics: "Metrics", operator: "Operator", started: "Started", restore: "Restore" },
