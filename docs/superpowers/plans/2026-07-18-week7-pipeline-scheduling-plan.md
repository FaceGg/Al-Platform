...
- [x] **Step 1: Write failing tests for Cron and timezone behavior**
...
- [x] **Step 4: Commit the dependency/test baseline**
...
- [x] **Step 1: Add model contract tests**
...
- [x] **Step 2: Run model tests to confirm RED**
...
- [x] **Step 3: Implement ORM models and imports**
...
- [x] **Step 1: Add RED tests for claims and idempotency**
...
- [x] **Step 3: Implement the minimal service boundary**
...
- [x] **Step 5: Commit the scheduler service**
...
- [x] **Step 2: Run behavior tests and confirm the expected failures**

```powershell
python -m unittest tests.test_pipeline_scheduler.TestSchedulerPolicies -v
```

- [x] **Step 3: Implement policy handling**
...
- [x] **Step 4: Verify all service tests**

```powershell
python -m unittest tests.test_pipeline_scheduler -v
```

- [x] **Step 5: Commit policy behavior**
...
- [x] **Step 1: Add RED task-registration tests**
...
- [x] **Step 2: Run registration tests and confirm RED**

```powershell
python -m unittest tests.test_pipeline_scheduler.TestSchedulerTasks -v
```

- [x] **Step 3: Implement task wiring**
...
- [x] **Step 4: Verify task tests and import smoke**
...
- [x] **Step 3: Implement Pydantic schemas and router**
...
- [x] **Step 4: Register the router and verify API tests**
...
- [x] **Step 1: Add RED composition assertions**
...
- [x] **Step 2: Run composition tests and confirm RED**

```powershell
python -m unittest tests.test_ci_workflow -v
```

- [x] **Step 3: Implement the scheduler service**
...
- [x] **Step 4: Update CI and validate YAML/Compose**
...
- [x] **Step 5: Commit deployment wiring**
...
- [x] **Step 6: Commit the final Week 7 scheduler delivery**
...
- [x] Final remote quality, production, experiment, and browser acceptance jobs are green: Actions Run `29667952189`.
